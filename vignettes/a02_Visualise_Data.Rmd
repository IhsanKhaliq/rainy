...
lesion_data <- read_csv(system.file(
  ...
  summarise(total_lesions = sum(lesions),
...
Plot the `total_rain` on the x-axis, `wind_speed` on the y-axis, the `rain_duration` as colour and `total_lesions` as the point size.
